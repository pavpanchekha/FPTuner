...
const float mlm_16_sin_fp32_cos_table[2048][1]  = {
    { 0x1p0f},
    { 0x1.ffff62p-1f},
    { 0x1.fffd88p-1f},
    { 0x1.fffa72p-1f},
...
float mlm_16_sin_fp32(float vx){
    ...
    if (__builtin_expect(NaN_or_Inf, 0)) {
        ...
        tmp16 = _mm_add_ss(mlm_16_sin_fp32_c_21, tmp15);
        poly_sin = _mm_mul_ss(red_vx2_, tmp16);
        tmp17 = _mm_set1_epi32(modk);
        tmp18 = _mm_add_epi32(tmp17, mlm_16_sin_fp32_cst39);
        tmp19 = _mm_cvtsi128_si32(tmp18);
        tmp20 = _mm_cvtsi128_si32(mlm_16_sin_fp32_cst40);
