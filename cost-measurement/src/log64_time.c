...
typedef fp64(*logtype)(fp64);

#define FUNC_COUNT (16)

logtype FUNCTIONS[FUNC_COUNT] = {ord_01_log_fp64,
                                 ord_02_log_fp64,
                                 ord_03_log_fp64,
                                 ord_04_log_fp64,
                                 ord_05_log_fp64,
...
void time_logs64(size_t log2_values, size_t log2_invocations, size_t runs)
{
...
int main(int argc, char** argv)
{
  ...
  time_logs64(log2_values, log2_invocations, runs);
  return 0;
}
